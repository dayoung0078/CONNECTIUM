...
#title {
  width: 100%; height: 50px; background: white; box-shadow: 0px 3px 7px #c4c4c4; border-radius: 20px; border: 3px #ffffff solid;
}
#author {
  width: 100%; height: 50px; background: white; box-shadow: 0px 3px 7px #c4c4c4; border-radius: 20px; border: 3px #ffffff solid;
}
...
textarea {
  ...
  padding-top: 50px;
  padding-left: 30px;
  padding-right: 120px; /* 오른쪽에 아이콘을 위한 공간 확보 */
  box-shadow: 0px 3px 7px #c4c4c4; border-radius: 20px; border: 3px #ffffff solid;
}
.image-upload-area {
  position: absolute;
  top: 40px;
...
#submit {
  width: 200px; height: 50px; background: #707070; box-shadow: 0px 3px 7px #c4c4c4; border-radius: 20px; border: 3px #ffffff solid;
  color: white;
  font-size: 20px;
